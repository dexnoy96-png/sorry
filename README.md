...
<body>
    ...
    <div class="container">
        ...
        <p>เค้ารู้ตัวแล้วว่าเค้าดื้อ.. หายงอนเค้านะครับคนเก่ง <br> สัญญาว่าจะดูแลหัวใจให้ดีกว่าเดิม 🥺</p>
    ...
    <script>
        ...
        function celebrate() {
            document.querySelector('.container').innerHTML = "<h1>เย้! รักที่สุดเลย ❤️</h1><p>เดี๋ยวเย็นนี้เค้ามีรางวัลให้เป็นของอร่อยนะครับ!</p><img src='https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueGZ4bm9uM2R6eGZ4bm9uM2R6eGZ4bm9uM2R6eGZ4bm9uJmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/v3p3CtSrNYNLa/giphy.gif' width='150'>";
